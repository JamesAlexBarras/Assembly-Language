...
.code
	main proc
		...
		CounterLoop:				;this will increment the proper 'elements' of c1 and c2
			...
			loop CounterLoop		;after this loop terminates our counter arrays will have the proper values
		...
		VerifyLoop:
			...
			inc esi					;increment esi
			loop VerifyLoop
			mov eax, 1				;if the loop terminates adn we have not jumped then we know we have an anagram
